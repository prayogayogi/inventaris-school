...
<head>
	...
	<link rel="icon" type="image/png" href="<?= base_url(); ?>assets/icon/logo-sma.png">
...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<!-- Sidebar -->
		<ul class="navbar-nav bg-gradient-secondary sidebar sidebar-dark accordion" id="accordionSidebar" style="background: #B983FF;">
